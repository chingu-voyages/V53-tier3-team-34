    ...
    const getPresetRange = useCallback((presetName: string): DateRange => {
      ...
      switch (preset.name) {
        ...
        case "thisWeek": {
          ...
          endOfWeek.setDate(
            tomorrowForWeek.getDate() + (7 - endOfWeek.getDay()),
          ); // Next Sunday
        ...
        <PopoverContent align={align} className="w-auto">
          ...
          <div className="flex justify-end gap-2">
            ...
            <Button
              onClick={() => {
                setIsOpen(false);
                console.log("Previous range:", initialDateFrom, initialDateTo);
                console.log("Updated range:", range.from, range.to);
              ...
              className="px-6 py-2 bg-[#084be7] h-16 font-bold text-white rounded-none"
            >
              Update
            </Button>
          </div>
