...
interface ActivitySelectorProps {
  ...
  onChange: (activityValue: string | null) => void;
}
...
const ActivitySelector: React.FC<ActivitySelectorProps> = ({
  ...
  const handleSelectChange = (activityValue: string | null) => {
    if (activityValue === "default") {
      onChange("");
      setIsOption(false);
      return;
    }
  ...
  return (
    <div className="relative w-full text-white">
      ...
      >
        {selectedActivity ? (
          <>
            <span>{selectedActivityObj?.icon}</span>
            <p>{selectedActivityObj?.text}</p>
          </>
        ) : (
          <>
            <span>
